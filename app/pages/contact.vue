<template>
  <div>
    <section class="bg-black pt-10" id="contact">
              ...
              <ul class="mb-6 md:mb-0">
                ...
                <li class="flex">
                  ...
                  <div class="ml-4 mb-4">
                    ...
                    <p class="text-gray-600 dark:text-slate-400">
                      Mail: support@starlinksales.com
                    </p>
                  </div>
                </li>
                <li class="flex">
...
useSeoMeta({
  title: 'Starlink Online | Support',
  ogTitle: 'Support | Starlink Online',
   twitterTitle: 'Support | Starlink Online'
})
useHead({
  link: [
    {rel: 'canonical', href: 'https://starlinkonline.vercel.app/contact'}
  ]
})
</script>
